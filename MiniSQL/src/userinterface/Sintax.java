...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Nov 21 20:32:04 CST 2019
  */
  ...
  public final java_cup.runtime.Symbol CUP$Sintax$do_action(
    ...
    RESULT = new Simbolo(flotante.toString());
       ...
       if(!(Simbolo.encontrarId(Simbolos,V.getId()).size()==0)){
            ...
            if(!(TD.getAtributo("largoMax")==null)){
                RESULT.setAtributos("largoMax="+TD.getAtributo("largoMax"));
                if(!(TD.getAtributo("decimal")==null)){
                    RESULT.setAtributos("decimal="+TD.getAtributo("decimal"));
                }        
            }
            if(!(VV == null)){
