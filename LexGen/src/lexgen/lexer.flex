...
tipodatoOtro = "CURSOR"|"HIERARCHYID"|"ROWVERSION"|"SQL_VARIANT"|"UNIQUEIDENTIFIER"|"XML"
tipodatoEntero = "BIGINT"|"INT"|"SMALLINT"|"TINYINT"
tipodatoBit = "BIT"
tipodatoDecimalExacto = "DECIMAL"|"MONEY"|"NUMERIC"|"SMALLMONEY"
tipodatoDecimalAprox = "FLOAT"|"REAL"
tipodatoFechaHora = "DATE"|"DATETIME"|"DATETIME2"|"DATETIMEOFFSET"|"SMALLDATETIME"|"TIME"
tipodatoChars = "CHAR"|"TEXT"|"VARCHAR"
tipodatoUnicode = "NCHAR"|"NTEXT"|"NVARCHAR"
tipodatoBin = "BINARY"|"IMAGE"|"VARBINARY"
...
{tipodatoOtro} {lin=yyline; col=yycolumn; len=yylength(); lexeme=yytext(); return TipoDatoOtro;}
{tipodatoEntero} {lin=yyline; col=yycolumn; len=yylength(); lexeme=yytext(); return TipoDatoEntero;}
{tipodatoBit} {lin=yyline; col=yycolumn; len=yylength(); lexeme=yytext(); return TipoDatoBit;}
{tipodatoDecimalExacto} {lin=yyline; col=yycolumn; len=yylength(); lexeme=yytext(); return TipoDatoDecimalExacto;}
{tipodatoDecimalAprox} {lin=yyline; col=yycolumn; len=yylength(); lexeme=yytext(); return TipoDatoDecimalAprox;}
{tipodatoFechaHora} {lin=yyline; col=yycolumn; len=yylength(); lexeme=yytext(); return TipoDatoFechaHora;}
{tipodatoChars} {lin=yyline; col=yycolumn; len=yylength(); lexeme=yytext(); return TipoDatoChars;}
{tipodatoUnicode} {lin=yyline; col=yycolumn; len=yylength(); lexeme=yytext(); return TipoDatoUnicode;}
{tipodatoBin} {lin=yyline; col=yycolumn; len=yylength(); lexeme=yytext(); return TipoDatoBin;}
